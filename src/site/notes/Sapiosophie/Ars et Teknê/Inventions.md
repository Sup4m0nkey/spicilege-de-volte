---
{"dg-publish":true,"permalink":"/Sapiosophie/Ars et Teknê/Inventions/","hide":true,"tags":["Projets","Idées","Archiviste"],"noteIcon":"","updated":"2025-11-05T05:22:31.920+01:00"}
---
...
#Janjan ► Arme de GN pour la Joute #Philosophie 
...
#Évane : I.A. ► Arctic Monkeys qui fait une reprise de Red Hot Chili Pepper #Arts #Projets #Idées
### Audiovisuel

[[Grafictions et Racontoires/Prosopopées/Bienvenue dans le Terrier\|Bienvenue dans le Terrier]] #Projets #EnCours 
...
God game : player = enfant qui joue dans un bac à sable / toy story
...
"grid" par "case", avec pourcentage de chance par grid d'être touché, et pourcentage par chance d'être touché (genre, 1 case = 9 grid, donc 10% supp par grid avec 10% de base = 100%).
...
Inertie, donc freinage / changement de direction = PA (Space engineers)
